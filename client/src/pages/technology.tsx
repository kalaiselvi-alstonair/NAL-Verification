  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-accent-blue mb-6">Our Technology</h1>
          ...
          <div className="bg-accent-blue text-white p-12 rounded-xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Government Portal Integrations</h2>
              <p className="text-xl text-accent-mint">Seamless integration with 15+ government portals across India</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {portalIntegrations.map((integration, index) => (
                <div key={index} className="text-center">
                  <h3 className="text-xl font-semibold mb-4 text-accent-mint">{integration.state}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-accent-blue mb-4">Performance Metrics</h2>
            <p className="text-xl text-muted-foreground">Real-time performance statistics that matter</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <StatsCard value="99.9%" label="System Uptime" className="bg-accent-mint text-white" />
            <StatsCard value="< 20min" label="Average Processing Time" className="bg-accent-blue text-white" />
            <StatsCard value="98.5%" label="Document Fetch Success Rate" className="bg-accent-purple text-white" />
            <StatsCard value="95%" label="OCR Accuracy" className="bg-accent-orange text-white" />
          </div>
        </div>
      </section>
    </div>
