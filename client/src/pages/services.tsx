      ...
      <section className="py-20 bg-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Choose the verification package that best fits your needs.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <Card key={index} className={`shadow-lg ${pkg.popular ? 'border-2 border-primary relative' : ''}`}>
                {pkg.popular && (
